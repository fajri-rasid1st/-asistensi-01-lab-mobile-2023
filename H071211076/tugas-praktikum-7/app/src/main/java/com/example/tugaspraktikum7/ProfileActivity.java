...
import com.example.tugaspraktikum7.api.ApiConfig;
import com.example.tugaspraktikum7.api.SingleUserDataResponse;
import com.example.tugaspraktikum7.api.UserResponse;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void showData(int id) {
        ...
        executor.execute(() -> {
            ...
            Call<SingleUserDataResponse> client = ApiConfig.getApiService().getUserById(id);
            handler.post(() -> {
                //UI Thread work here
