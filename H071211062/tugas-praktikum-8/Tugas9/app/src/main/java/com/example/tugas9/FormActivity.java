...
public class FormActivity extends AppCompatActivity {
    ...
    private void save() {
        ...
        contentValues.put(DbContract.NoteColumns.TITLE, title);
        contentValues.put(DbContract.NoteColumns.DESCRIPTION, description);
        contentValues.put(DbContract.NoteColumns.CREATED_AT, createdAt);

        if (isEdit) {
            contentValues.put(DbContract.NoteColumns.IS_EDITED, 1);
